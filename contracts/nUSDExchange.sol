...
contract nUSDExchange is ERC20, Ownable, ReentrancyGuard {
    ...
    //  Enables users to deposit ETH and obtain 50% of that
    ...
    function totalNusdMinted() external view returns (uint256) {
        return totalSupply();
    }
